  ...
  return (
    <>
     <div id="europaContainer">
            <div id="europaHeader" className='text-white text-center font-["Bellefair"] text-[56px] font-normal uppercase mb-[1px]'>
              <h1>{Data.destinations[2].name}</h1>
            </div>
            <div id="europaCopy" className='text-lightBlue text-center font-["Barlow"] text-[15px] font-normal leading-[25px] mb-8'>
              <p>{Data.destinations[2].description}</p>
            </div>
            <div id="europaBreakLine" className='w-full h-[1px] bg-[#383B4B] mb-8'/>
            <div id="europaDistanceContainer" className='flex flex-col items-center mb-8'>
