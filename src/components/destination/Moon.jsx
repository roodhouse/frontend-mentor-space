  ...
  return (
    <>
     <div id="moonContainer">
            <div id="moonHeader" className='text-white text-center font-["Bellefair"] text-[56px] font-normal uppercase mb-[1px] md:text-[80px] md:mb-2'>
              <h1>{Data.destinations[0].name}</h1>
            </div>
            <div id="moonCopy" className='text-lightBlue text-center font-["Barlow"] text-[15px] font-normal leading-[25px] mb-8 md:text-base md:leading-[28px] md:w-[573px] md:mb-[49px]'>
