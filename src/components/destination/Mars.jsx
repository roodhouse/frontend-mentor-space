  ...
  return (
    <>
     <div id="marsContainer">
            <div id="marsHeader" className='text-white text-center font-["Bellefair"] text-[56px] font-normal uppercase mb-[1px] md:text-[80px] md:mb-2'>
              <h1>{Data.destinations[1].name}</h1>
            </div>
            <div id="marsCopy" className='text-lightBlue text-center font-["Barlow"] text-[15px] font-normal leading-[25px] mb-8 md:text-base md:leading-[28px] md:w-[573px] md:mb-[49px]'>
              <p>{Data.destinations[1].description}</p>
            </div>
            <div id="marsBreakLine" className='w-full h-[1px] bg-[#383B4B] mb-8 md:mb-7'/>
            <div id="distanceMarsTravel" className='md:flex md:justify-evenly md:mb-[62px]'>
              <div id="marsDistanceContainer" className='flex flex-col items-center mb-8 md:mb-0'>
