  ...
  return (
    <>
      <div id="missionSpecialistContainer" className='md:flex md:flex-col md:justify-center md:items-center md:mb-10'>
        ...
        <div id="missionSpecialistBio" className='text-lightBlue text-center text-[15px] font-["Barlow"] font-normal leading-[25px] md:text-base md:leading-[28px] md:w-[458px]'>
          <p>{Data.crew[1].bio}</p>
        </div>
      </div>
    </>
