...
function Button() {
  return (
    <>
      <div id="exploreButtonContainer" className='flex justify-center cursor-pointer xl:border-[88px] xl:border-[transparent] xl:hover:border-[88px] xl:hover:border-[rgba(255,255,255,0.5)] xl:hover:rounded-[50%]'>
