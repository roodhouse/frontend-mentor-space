...
function App() {
  ...
  return (
    <div className="App flex flex-col h-screen">
      <div id='mainWrapper' className='flex justify-center h-auto grow bg-[url("/src/assets/home/background-home-mobile.jpg")] bg-cover pt-6 pb-12 bg-no-repeat mix-blend-screen md:bg-[url("/src/assets/home/background-home-tablet.jpg")] md:pb-0 xl:bg-[url("/src/assets/home/background-home-desktop.jpg")] xl:pt-16'>
